...
import cn.tties.maint.view.Dust_DescriptionDialog;
...
@ContentView(R.layout.fragment_dust)
public class DustFragment extends BaseFragment implements View.OnClickListener{
    private static final String TAG = "FaultFragment";
    public static DustFragment dustFragmentInstance;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        dustFragmentInstance = this;
    }
    @SuppressLint("ValidFragment")
    public DustFragment(Integer curEleId, String curEleNo, CompanyResult curCompany,int workOrderId){
    ...
    private void initPullRefresh() {
        orderPtrlayout.setPtrHandler(new PtrHandler() {
            ...
            public void onRefreshBegin(PtrFrameLayout frame) {
                DustFragment.this.getPrettiftList();
            }
            @Override
        ...
        switch (view.getId()){
            case R.id.prettift_before://处理前
                if(!isbefore){
                    ...
                    Prettift_SelectDescriptionDialog moreDialog=new Prettift_SelectDescriptionDialog(DustFragment.this,resultBeanbefor,beforeNum);
            ...
            case R.id.prettift_later://处理后
                if(!islater){
                    ...
                    Prettift_SelectDescriptionDialog moreDialog=new Prettift_SelectDescriptionDialog(DustFragment.this,resultBeanlater,laterNum);
                    moreDialog.setContentView();
                    moreDialog.loading();
                }
                break;
    ...
    public void getDialog(int description_type){
        dialog = new Dust_DescriptionDialog(DustFragment.this,curCompany.getCompanyId(),workOrderId,description_type);
        ...
        HttpClientSend.getInstance().send(params,new BaseStringCallback(){
            ...
            public void onSuccess(String result) {
                ...
                if(ret.getErrorCode()!=0){
                    ...
                    Toast.makeText(x.app(), "获取除尘清理巡视项失败", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void getPrettiftStatusList(){
        ...
        HttpClientSend.getInstance().send(params,new BaseStringCallback(){
            ...
            public void onSuccess(String result) {
                ...
                if(ret.getErrorCode()!=0){
                    Toast.makeText(x.app(), "查询除尘清理状态失败", Toast.LENGTH_SHORT).show();
                    return;
                }
                //处理前处理后

...
public class CommonListViewAdapter<T extends CommonListViewInterface> extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_common, parent, false);
        }
        TextView textOverhaul = (TextView) convertView.findViewById(R.id.text_name);
        textOverhaul.setText(item.getItemName());
        View selView = (View) convertView.findViewById(R.id.view_sel);
        if (item.isChecked()) {

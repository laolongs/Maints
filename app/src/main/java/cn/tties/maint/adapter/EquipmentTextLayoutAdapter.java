...
public class EquipmentTextLayoutAdapter extends BaseAdapter {
    ...
    public EquipmentTextLayoutAdapter(Context context, List<EquipmentLayoutBean> beanList) {
    ...
    public EquipmentTextLayoutAdapter(List<EquipmentLayoutBean> beanList) {
        this.beanList = beanList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            switch (bean.getType()) {
                case EDITTEXT:
                    convertView = View.inflate(x.app(), R.layout.layout_textview, null);
...
//                        }
    ...
    class ViewEditTextHolder {
        ...
        public ViewEditTextHolder(View convertView) {
            ...
            value = (TextView) convertView.findViewById(R.id.edit_value);
        }
    }
    /**
     * 第四种布局的Holder

...
public class FaultDescriptionListViewAdapter extends BaseAdapter {
    private List<QueryFaultResult.ResultBean.QuestionDescriptionListBean> mDataList;
    private BaseFragment mFragment;
    public FaultDescriptionListViewAdapter(BaseFragment fragment, List<QueryFaultResult.ResultBean.QuestionDescriptionListBean> mList) {
        mDataList = mList;
    ...
    public FaultDescriptionListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    @Override
    public QueryFaultResult.ResultBean.QuestionDescriptionListBean getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final QueryFaultResult.ResultBean.QuestionDescriptionListBean result = getItem(position);
        if (convertView == null) {
        ...
        if (result.getImageBeanList() != null) {
            ...
            FaultDescriptionListViewAdapter.OnRecyclerViewItemClickListener clickListener = new FaultDescriptionListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override
    ...
    public void setmDataList(List<QueryFaultResult.ResultBean.QuestionDescriptionListBean> mDataList) {

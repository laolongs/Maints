...
public class FaultEndListViewAdapter extends BaseAdapter {
    private List<QueryFaultResult.ResultBean.QuestionScheduleListBean> mDataList;
    private BaseFragment mFragment;
    public FaultEndListViewAdapter(BaseFragment fragment, List<QueryFaultResult.ResultBean.QuestionScheduleListBean> mList) {
        mDataList = mList;
        this.mFragment = fragment;
    }
    public FaultEndListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    @Override
    public QueryFaultResult.ResultBean.QuestionScheduleListBean getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final QueryFaultResult.ResultBean.QuestionScheduleListBean result = getItem(position);
        if (convertView == null) {
        ...
        if (result.getImageBeanList() != null) {
            ...
            FaultEndListViewAdapter.OnRecyclerViewItemClickListener clickListener = new FaultEndListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override
    ...
    public void setmDataList(List<QueryFaultResult.ResultBean.QuestionScheduleListBean> mDataList) {

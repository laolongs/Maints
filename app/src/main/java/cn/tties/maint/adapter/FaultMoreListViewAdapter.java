...
public class FaultMoreListViewAdapter extends BaseAdapter {
    private List<QueryFaultResult.ResultBean.QuestionDescriptionListBean> mDataList;
    private BaseFragment mFragment;
    public FaultMoreListViewAdapter(BaseFragment fragment, List<QueryFaultResult.ResultBean.QuestionDescriptionListBean> mList) {
        mDataList = mList;
        this.mFragment = fragment;

    }
    public FaultMoreListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (result.getImageBeanList() != null) {
            ...
            FaultMoreListViewAdapter.OnRecyclerViewItemClickListener clickListener = new FaultMoreListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override

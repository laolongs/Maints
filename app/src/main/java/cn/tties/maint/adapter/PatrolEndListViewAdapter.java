...
public class PatrolEndListViewAdapter extends BaseAdapter {
    private List<PatrolResult.QuertionBean.QuestionScheduleListBean> mDataList;
    private BaseFragment mFragment;
    public PatrolEndListViewAdapter(BaseFragment fragment,List<PatrolResult.QuertionBean.QuestionScheduleListBean> mList) {
        mDataList = mList;
        this.mFragment = fragment;

    }

    public PatrolEndListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    @Override
    public PatrolResult.QuertionBean.QuestionScheduleListBean getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final PatrolResult.QuertionBean.QuestionScheduleListBean result = getItem(position);
        if (convertView == null) {
        ...
        if (result.getImageBeanList() != null) {
            ...
            PatrolEndListViewAdapter.OnRecyclerViewItemClickListener clickListener = new PatrolEndListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override
    ...
    public void setmDataList(List<PatrolResult.QuertionBean.QuestionScheduleListBean> mDataList) {

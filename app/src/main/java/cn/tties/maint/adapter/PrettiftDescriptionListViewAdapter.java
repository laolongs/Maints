...
public class PrettiftDescriptionListViewAdapter extends BaseAdapter {
    PrettiftStatusAndDetailsResult.ResultBean resultBeanAll;

    private BaseFragment mFragment;

    public PrettiftDescriptionListViewAdapter(BaseFragment fragment,PrettiftStatusAndDetailsResult.ResultBean resultBeanAll) {
        this.resultBeanAll = resultBeanAll;
        this.mFragment = fragment;
    }
    @Override
    public int getCount() {
        if (null == this.resultBeanAll) {
            return 0;
        }
        return 1;
    }
...
//    }
        ...
        if (resultBeanAll.getListImg() != null) {
            ...
            PrettiftDescriptionListViewAdapter.OnRecyclerViewItemClickListener clickListener = new PrettiftDescriptionListViewAdapter.OnRecyclerViewItemClickListener() {
                ...
                public void onItemClick(View view, final int pos) {
                    ...
                    String path = resultBeanAll.getListImg().get(pos).path;
                    //打开预览
    ...
    public void setmDataList(PrettiftStatusAndDetailsResult.ResultBean resultBeanAll) {
        this.resultBeanAll = resultBeanAll;
    }

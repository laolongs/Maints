...
public class QuestionEndListViewAdapter extends BaseAdapter {
    private List<QuestionNewScheduleResult> mDataList;
    private BaseFragment mFragment;
    public QuestionEndListViewAdapter(BaseFragment fragment, List<QuestionNewScheduleResult> mList) {
        mDataList = mList;
        this.mFragment = fragment;

    }

    public QuestionEndListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    @Override
    public QuestionNewScheduleResult getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final QuestionNewScheduleResult result = getItem(position);
        if (convertView == null) {
        ...
        if (result.getImageBeanList() != null) {
            ...
            QuestionEndListViewAdapter.OnRecyclerViewItemClickListener clickListener = new QuestionEndListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override
    ...
    public void setmDataList(List<QuestionNewScheduleResult> mDataList) {

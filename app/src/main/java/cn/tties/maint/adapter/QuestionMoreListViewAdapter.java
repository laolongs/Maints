...
public class QuestionMoreListViewAdapter extends BaseAdapter {
    private List<DescriptionResult> mDataList;
    private BaseFragment mFragment;

    public QuestionMoreListViewAdapter(BaseFragment fragment, List<DescriptionResult> mList) {
        mDataList = mList;
        this.mFragment = fragment;
    }

    public QuestionMoreListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    @Override
    public DescriptionResult getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final DescriptionResult result = getItem(position);
        if (convertView == null) {
        ...
        if (result.getImageBeanList() != null) {
            ...
            QuestionMoreListViewAdapter.OnRecyclerViewItemClickListener clickListener = new QuestionMoreListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override
    ...
    public void setmDataList(List<DescriptionResult> mDataList) {

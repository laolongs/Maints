...
public class TableAccountAdapter extends BaseAdapter {

    public List list;
    public LayoutInflater inflater;

    public TableAccountAdapter() {
    }

    public TableAccountAdapter(Context context, List<Object> list)  {
        this.list = list;
    ...
    public View getConvertView(View convertView) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.table_account, null);
            ...
            viewHolder.text4 = (TextView) convertView.findViewById(R.id.text_4);

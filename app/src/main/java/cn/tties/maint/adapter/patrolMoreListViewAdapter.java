...
public class patrolMoreListViewAdapter extends BaseAdapter {
    private List<PatrolResult.QuertionBean.QuestionDescriptionListBean> mDataList;
    private BaseFragment mFragment;
    private String creattime;

    public patrolMoreListViewAdapter(BaseFragment fragment, List<PatrolResult.QuertionBean.QuestionDescriptionListBean> mList,String creattime) {
        mDataList = mList;
        this.mFragment = fragment;
        this.creattime=creattime;
    }

    public patrolMoreListViewAdapter(BaseFragment fragment) {
        this.mFragment = fragment;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.textTime.setText(creattime);
        if (result.getImageBeanList() != null) {
            ImageAdapter adapter = new ImageAdapter(mFragment.getContext(), result.getImageBeanList());
            patrolMoreListViewAdapter.OnRecyclerViewItemClickListener clickListener = new patrolMoreListViewAdapter.OnRecyclerViewItemClickListener() {
                @Override
    ...
    class ViewHolder {
        ViewHolder(View view) {
            ...
            textTitle = (TextView) view.findViewById(R.id.text_time);

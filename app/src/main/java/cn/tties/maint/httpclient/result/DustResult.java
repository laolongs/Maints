...
public class DustResult {


    /**
     * result : [{"flag":0,"itemOrder":2,"faultType":2,"faultHarm":"缺陷危害","prettifyDustType":2,"title":"除尘","prettifyDustItemId":0,"dealDesc":"除尘描述"}]
     * errorMessage : 成功
     * errorCode : 0
     */

 ...
 * author chensi
 */
public class DescriptionDialog extends BaseCustomDialog {
    EditText editDescription;
    Integer staffId;
    Integer questionId;
    List<ImageItem> imageItemsList;
    DescriptionImageListViewAdapter adapter;
    BaseFragment mFragment;
    int maxCount = 9;
    int mPostion;

    public DescriptionDialog(BaseFragment fragment, Integer staffId, Integer questionId) {
        super(MyApplication.curActivity, null);
        this.staffId = staffId;
        this.questionId = questionId;
        adapter = new DescriptionImageListViewAdapter(fragment.getContext(), new ArrayList<ImageItem>(), maxCount);
    ...
    DescriptionImageListViewAdapter.OnRecyclerViewItemClickListener clickListener = new DescriptionImageListViewAdapter.OnRecyclerViewItemClickListener() {
        @Override
    ...
    public void loading() {
        mClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String title = editDescription.getText().toString();

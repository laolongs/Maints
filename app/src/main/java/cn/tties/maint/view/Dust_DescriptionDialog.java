...
import cn.tties.maint.activity.DustFragment;
 ...
 *
 */
public class Dust_DescriptionDialog {
    private static final String TAG = "Dust_DescriptionD";
    ...
    AlertDialog dialog;
    int prettifyDustType=2;//除尘
    public Dust_DescriptionDialog(BaseFragment fragment, int companyId, int workOrderId, int description_type) {
            ...
            public void onClick(View view) {
                ...
                HttpClientSend.getInstance().sendFile(params, fileList,new BaseStringCallback() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        DustFragment.dustFragmentInstance.getPrettiftStatusList();
                      dialog.dismiss();
                    }
                });
            }

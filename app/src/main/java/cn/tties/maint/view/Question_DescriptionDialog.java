 ...
 * author chensi
 */
public class Question_DescriptionDialog {
    private static final String TAG = "Question_DescriptionD";
    ...
    int questionId;
    AlertDialog dialog;
    public Question_DescriptionDialog(BaseFragment fragment,int questionId) {

...
//        wl.width = LayoutParams.MATCH_PARENT;
        WindowManager m = MyApplication.curActivity.getWindowManager();
        Display d = m.getDefaultDisplay(); // 获取屏幕宽、高用
        wl.width = (int) (d.getWidth() * 0.25);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.darkblue);
                mOtherItemColor = mActivity.getResources().getColor(R.color.darkblue);
            }
            if (1 == mStrings.size()) {
